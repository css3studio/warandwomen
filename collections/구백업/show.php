...
<div class="container pt-8 pb-28">
	...
	<!-- //네비게이터 -->
	<div class="grid grid-cols-2 gap-x-8 gap-y-20">
		<div>
			<div class="mb-20">	
			...
			<div>	
				<h2 class="text-3xl font-bold mb-8">컬렉션의 구성</h2>		
...
<div class="container pt-8 pb-28">
	...
	<div class="mb-20">	
		...
		<div class="w-full aspect-[1280/424] mb-20">
			<p><?php if ($개요!= null) { ?><?php echo $개요; ?><?php } else { ?><?php } ?></p>
		</div>
	</div>
	...
	<div class="mb-20">	
		...
		<div class="w-full aspect-[1280/424] mb-20">
			<p><?php if ($기록구성!= null) { ?><?php echo strip_formatting($기록구성); ?><?php } else { ?><?php } ?></p>
		</div>
	</div>
	...
	<div class="mb-20">	
		...
		<div class="w-full aspect-[1280/424] mb-20">
			<p><?php if ($아카이브히스토리!= null) { ?><?php echo strip_formatting($아카이브히스토리); ?><?php } else { ?><?php } ?></p>
		</div>
	</div>
	...
	<div class="mb-20">	
		...
		<div class="w-full aspect-[1280/424] mb-20">
			<p><?php if ($검색방법!= null) { ?><?php echo $검색방법; ?><?php } else { ?><?php } ?></p>
		</div>
	</div>
