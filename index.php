...
<body>
    <div id="wrap">
        ...
        <header id="header" role="banner" class="fixed w-full lg:pt-10 pt-[34px] bg-white z-20">
            <div class="container lg:h-14 h-11 flex justify-between items-center relative z-10">
                <a class="brand" href="/">
                    ...
                    <img class="white lg:h-14 h-10" src="<?php echo img('logo-white.png'); ?>" alt="전쟁과여성인권 아카이브">
                </a>
        ...
        <article id="content" role="main" tabindex="-1" class="pt-0"><!--pt-24-->
                ...
                <div class="section relative bg-[url('<?php echo img('banner-main01.png'); ?>')] bg-cover" style="background-image: url(<?php echo img('banner-main01.png'); ?>); background-repeat: no-repeat; background-size: cover;">
                    <div class="container text-white">
                        ...
                        <ul class="flex lg:gap-12 gap-7 lg:text-3xl text-xl font-bold">
                            <li><a href="#" class="flex hover:text-primary">기록<i class="xi-angle-right-min ml-1 lg:text-[2.2rem] text-2xl relative lg:-top-0.5"></i></a></li>
                            <li><a href="#" class="flex hover:text-primary">시간<i class="xi-angle-right-min ml-1 lg:text-[2.2rem] text-2xl relative lg:-top-0.5"></i></a></li>
                            <li><a href="#" class="flex hover:text-primary">이야기<i class="xi-angle-right-min ml-1 lg:text-[2.2rem] text-2xl relative lg:-top-0.5"></i></a></li>
                        </ul>
                    </div>
                            ...
                            <ul class="text-white lg:grid grid-cols-2 gap-8 lg:max-h-[624px] lg:h-[calc(100vh-490px)] w-[343px] lg:w-auto">
                                <li class="relative mr-4 lg:mr-0 overflow-hidden lg:row-span-2">
                                    ...
                                    <dl class="absolute top-0 left-0 lg:py-10 py-8 lg:px-8 px-6">
                                        ...
                                        <dd><a class="hover:underline" href="#">컬렉션 보기</a></dd>
                                    </dl>
                                </li>
                        ...
                        <div class="main-info">
                            <ul class="text-white lg:grid grid-cols-3 gap-8 lg:max-h-[624px] lg:h-[calc(100vh-490px)] w-[343px] lg:w-auto">
                                <li class="relative mr-4 lg:mr-0 overflow-hidden">
                                    ...
                                    <a href="#" class="absolute bottom-0 left-0 lg:py-8 lg:px-6 py-6 px-4 w-full flex justify-between">
